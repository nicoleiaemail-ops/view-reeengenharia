export function FAQ() {
  const faqs = [
    ...
    { q: "Quanto tempo leva para ver resultados?", a: "O diagnóstico gratuito é concluído em 48 horas. Projetos de automação costumam ter <strong>primeiros resultados visíveis entre 2 e 4 semanas</strong> após o início da implementação." },
